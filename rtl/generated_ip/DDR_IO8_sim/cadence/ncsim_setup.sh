...
TOP_LEVEL_NAME="DDR_IO8"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/petya/ssd/intelFPGA_lite/21.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_gpio_lite/altera_gpio_lite.sv" -work DDR_IO8 -cdslib ./cds_libs/DDR_IO8.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/DDR_IO8.v"                                                                            
fi
