...
// bios_read_uart(dst, size, crc, uart_divisor_override /* -1 - don't override */) -> ok
#define bios_read_uart    ((int (*)(char*, int, unsigned, int))      (BIOS_ROM_ADDR + 0x20))
#define bios_wait_reset   ((void (*)())                              (BIOS_ROM_ADDR + 0x24))
